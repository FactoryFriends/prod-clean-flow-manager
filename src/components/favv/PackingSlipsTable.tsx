...
export function PackingSlipsTable({ packingSlips, isLoading }: PackingSlipsTableProps) {
  const [selectedPackingSlip, setSelectedPackingSlip] = useState<PackingSlip | null>(null);
  const [isModalOpen, setIsModalOpen] = useState(false);

  const handleRowClick = (packingSlip: PackingSlip) => {
    setSelectedPackingSlip(packingSlip);
    setIsModalOpen(true);
  };
  ...
  return (
    <>
      ...
      <PackingSlipDetailsModal
        packingSlip={selectedPackingSlip}
        isOpen={isModalOpen}
