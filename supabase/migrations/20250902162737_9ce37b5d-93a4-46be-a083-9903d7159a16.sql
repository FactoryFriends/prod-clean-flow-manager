...
-- Step 3: Reset manual stock adjustment for TOM-20250829-001 back to 0 (using correct UUID)
UPDATE production_batches 
SET manual_stock_adjustment = 0 
WHERE id = 'b85de0ec-5a84-49e4-bc48-a1302545d78e';
...
(
  ...
  'tothai', 
  'batch', 
  '{"batch_id": "TOM-20250829-001", "batch_uuid": "b85de0ec-5a84-49e4-bc48-a1302545d78e", "previous_adjustment": 6, "new_adjustment": 0}', 
  true
);