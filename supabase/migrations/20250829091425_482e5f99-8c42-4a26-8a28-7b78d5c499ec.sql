-- First, fix the existing negative value
UPDATE production_batches 
SET packages_produced = 1 
WHERE packages_produced < 0;

-- Now add the check constraint to prevent negative packages_produced
